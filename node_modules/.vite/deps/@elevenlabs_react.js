...
var L = class _L {
  ...
  static buildWebSocketUri(e3) {
    ...
    if (n2.append("model_id", e3.modelId), n2.append("token", e3.token), void 0 !== e3.commitStrategy && n2.append("commit_strategy", e3.commitStrategy), void 0 !== e3.vadSilenceThresholdSecs) {
  ...
  static connect(e3) {
    ...
    const t = new F("microphone" in e3 && e3.microphone ? 16e3 : e3.sampleRate), n2 = _L.buildWebSocketUri(e3), o3 = new WebSocket(n2);
  ...
  const Y = (0, import_react.useCallback)(async (n2 = {}) => {
    if (B.current) console.warn("Already connected");
      ...
      B.current = Q2, Q2.on(P.SESSION_STARTED, () => {
        ...
        const e4 = n3;
        K(e4.error), $("error"), null == R2 || R2(e4);
      }), Q2.on(P.OPEN, () => {
        null == b2 || b2();
      }), Q2.on(P.CLOSE, () => {
        $("disconnected"), B.current = null, null == w2 || w2();
      });
    } catch (n3) {
      const e4 = n3 instanceof Error ? n3.message : "Failed to connect";
      throw K(e4), $("error"), n3;
    }
  }, [y2, A2, f2, O2, U2, k2, F2, _3, P2, x2, N2, V, q, a3, s2, c3, d3, v3, m3, g2, p2, T2, C2, h3, E2, S2, M2, I2, D2, R2, b2, w2]), Z = (0, import_react.useCallback)(() => {
    var n2;
...
function m2(o3 = {}) {
  const { micMuted: t, volume: l2, serverLocation: a3 } = o3, m3 = function(n2, e3) {
    ...
    return r4;
  }(o3, s), g2 = (0, import_react.useRef)(null), p2 = (0, import_react.useRef)(null), [T2, C2] = (0, import_react.useState)("disconnected"), [h3, E2] = (0, import_react.useState)(false), [S2, M2] = (0, import_react.useState)("listening"), I2 = (0, import_react.useRef)(t), D2 = (0, import_react.useRef)(l2);
  return I2.current = t, D2.current = l2, (0, import_react.useEffect)(() => {
    var n2;
    ...
    try {
      ...
      } })), g2.current = await p2.current, void 0 !== I2.current && g2.current.setMicMuted(I2.current), void 0 !== D2.current && g2.current.setVolume({ volume: D2.current }), g2.current.getId();
    } finally {
      p2.current = null;
    }
  }, endSession: async () => {
    const n2 = g2.current;
    g2.current = null, await (null == n2 ? void 0 : n2.endSession());
  }, setVolume: ({ volume: n2 }) => {
    var e3;
    ...
    throw new Error("Device switching is only available for voice conversations");
  }, status: T2, canSendFeedback: h3, micMuted: t, isSpeaking: "speaking" === S2 };
}
export {
  O as AudioFormat,
  U as CommitStrategy,
